...
const addEmployee = () => {
    inquirer.prompt([
        ...
        .then((answer) => {
            ...
            server.promise().query(emRole, (err, res) => {
                if (err) throw err;
                ...
                inquirer.prompt([
                    ...
                    .then((answer) => {
                        ...
                        server.promise().query(emManager, (err, res) => {
                            if (err) throw err;
                            ...
                            inquirer.prompt([
                                ...
                                .then((answer) => {
                                    ...
                                    server.promise().query(query, { first_name: employeeCriteria[0], last_name: employeeCriteria[1], role_id: roleCriteria, manager_id: managerCriteria }, (err, res) => {
                                        if (err) throw err;
      ...
      .then((answer) => {
        if (answer.departmentName === 'Create New Department') {
          ...
          .then((answer) => {
            ...
            server.promise().query(query, criteria, (err, res) => {
              if (err) throw err;
...
const addDepartment = () => {
    ...
    inquirer.prompt([
        ...
        .then((answer) => {
            ...
            server.promise().query(query, answer.departmentName, (err, res) => {
                if (err) throw err;
